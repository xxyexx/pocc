...
<div class="row">
	...
	<div class="col-md-10 col-sm-8 right-div">
	    ...
	    <div class="main">
			...
			<s:iterator value="#request.logPage.List" var="LogData" >   
	  			<tr>
	  				<td>${LogData.role}</td>
	  				<td>${LogData.account}</td>
	  				<td>${LogData.name}</td>
	  				<td>${LogData.school}</td>
	  				<td>${LogData.operator_time}</td>
	  				<td>${LogData.operator_content}</td>
	  				<td><a class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span></a></td>
