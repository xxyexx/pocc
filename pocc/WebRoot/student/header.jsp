 ...
 <div class="container " align="left" id="nav-div">
  ...
  <div class="collapse navbar-collapse header" role="navigation">
    <ul class="nav navbar-nav navbar-right ">
        ...
        <li class="dropdown">
           <a href="#" class="dropdown-toggle TouserCenter" data-toggle="dropdown"><img class="img-circle" alt="头像" src="${session.User.icon_url}" width="22px" height="22px">&nbsp;<s:property value="#session.User.username"/></a>
