 ...
 <div class="container " align="left" id="nav-div">
  ...
  <div class="collapse navbar-collapse header" role="navigation">
    <ul class="nav navbar-nav navbar-right ">
        ...
        <li class="dropdown">
           <a href="#" class="dropdown-toggle TouserCenter" data-toggle="dropdown"><img class="img-circle" alt="头像" src="image/UserDefaultPic3.jpg" width="20px;">&nbsp;<s:property value="#session.User.username"/></a>
