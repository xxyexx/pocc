...
.main{
	min-height:600px;
	height:100%;
	background-image: url("image/Login_bg3.jpg");
		...
		<form method="post" action="VerifyLoginServlet">
			...
			<div class="row">
				...
				function checkForm(){//再次使用ajax提交检测用户信息
					$.ajax({
						url : "UserAction_Login.action",//todo:set the servelet of your own
						type : "post",
						data : {
							userName:"莫小平",
							password:"123456",
						...
						success : function(data) {
							alert("表单提交账号密码返回结果:"+ data.result );
						}
					});
				}
